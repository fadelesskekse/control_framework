...
: ${AMENT_CURRENT_PREFIX:="/home/dakota/.local/repos/control_framework/install/lockstep_sim"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lockstep_sim/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lockstep_sim/environment/path.sh"
