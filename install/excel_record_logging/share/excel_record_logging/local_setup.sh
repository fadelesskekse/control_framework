...
: ${AMENT_CURRENT_PREFIX:="/home/dakota/.local/repos/control_framework/install/excel_record_logging"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/excel_record_logging/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/excel_record_logging/environment/path.sh"
