...
#include "control_framework_interfaces/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const control_framework_interfaces::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_framework_interfaces::msg::State & ros_message)
{
  // Member: pos_state
  {
    cdr >> ros_message.pos_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_framework_interfaces::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_framework_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_framework_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  return &control_framework_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_framework_interfaces, msg, State)() {
  return &control_framework_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
