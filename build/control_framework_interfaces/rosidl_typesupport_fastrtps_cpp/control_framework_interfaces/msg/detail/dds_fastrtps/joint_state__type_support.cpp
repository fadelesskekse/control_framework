...
#include "control_framework_interfaces/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const control_framework_interfaces::msg::JointState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pos_state
  {
    cdr << ros_message.pos_state;
  }
  // Member: vel_state
  {
    cdr << ros_message.vel_state;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_framework_interfaces::msg::JointState & ros_message)
{
  // Member: pos_state
  {
    cdr >> ros_message.pos_state;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 2;
    size_t item_size = sizeof(ros_message.pos_state[0]);
  ...
  {
    size_t array_size = 2;
    size_t item_size = sizeof(ros_message.vel_state[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_framework_interfaces::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_framework_interfaces::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_framework_interfaces::msg::JointState *>(
    untyped_ros_message);
...
{
  return &control_framework_interfaces::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_framework_interfaces, msg, JointState)() {
  return &control_framework_interfaces::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
