...
static const _ControlInput_type_support_symbol_names_t _ControlInput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_framework_interfaces, msg, ControlInput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_framework_interfaces, msg, ControlInput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, control_framework_interfaces, msg, ControlInput)() {
  return &::control_framework_interfaces::msg::rosidl_typesupport_c::ControlInput_message_type_support_handle;
}
