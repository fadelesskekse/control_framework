...
#include "control_framework_interfaces/msg/detail/control_input__rosidl_typesupport_fastrtps_c.h"
...
using _ControlInput__ros_msg_type = control_framework_interfaces__msg__ControlInput;
...
size_t get_serialized_size_control_framework_interfaces__msg__ControlInput(
  const void * untyped_ros_message,
...
static uint32_t _ControlInput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_control_framework_interfaces__msg__ControlInput(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_framework_interfaces
size_t max_serialized_size_control_framework_interfaces__msg__ControlInput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_framework_interfaces__msg__ControlInput;
    is_plain =
      (
...
static size_t _ControlInput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_control_framework_interfaces__msg__ControlInput(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_framework_interfaces, msg, ControlInput)() {
