...
#include "control_framework_interfaces/msg/detail/joint_state__rosidl_typesupport_fastrtps_c.h"
...
using _JointState__ros_msg_type = control_framework_interfaces__msg__JointState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 2;
    auto array_ptr = ros_message->pos_state;
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: vel_state
  {
    size_t size = 2;
    auto array_ptr = ros_message->vel_state;
    cdr.serializeArray(array_ptr, size);
  }
...
size_t get_serialized_size_control_framework_interfaces__msg__JointState(
  const void * untyped_ros_message,
...
static uint32_t _JointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_control_framework_interfaces__msg__JointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_framework_interfaces
size_t max_serialized_size_control_framework_interfaces__msg__JointState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_framework_interfaces__msg__JointState;
    is_plain =
      (
      offsetof(DataType, vel_state) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _JointState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_control_framework_interfaces__msg__JointState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_framework_interfaces, msg, JointState)() {
